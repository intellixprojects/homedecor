                  ...
                  <AnimatePresence>
                    {profileDropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 top-[calc(100%+10px)] z-50 w-52 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl"
                      >
        ...
        {mobileOpen && (
          <>
            ...
            >
              ...
              {/* MOBILE PROFILE SECTION — shown only when logged in */}
              {currentUser && (
                <div className="border-b border-gray-100 px-5 py-4">
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-xl bg-[#f8f5f0] px-4 py-3 text-[13px] font-medium text-[#111827] transition hover:bg-[#f0e8d9]"
                  >
                        ...
                        <div className="mt-2 rounded-xl border border-gray-100 overflow-hidden">
                          {profileMenuItems.map((item) => (
                            <Link
                              ...
                              href={item.href}
                              onClick={() => setMobileOpen(false)}
                              className="flex items-center gap-3 border-b border-gray-100 px-4 py-3 text-[14px] font-medium text-[#111827] transition hover:bg-[#f8f5f0] hover:text-[#c9a96e]"
                            >
                              <item.icon className="text-[16px] shrink-0" />
                              {item.name}
                            </Link>
