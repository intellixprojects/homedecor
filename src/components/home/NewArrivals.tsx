          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="rounded-[28px] bg-[#ede9e3] h-[320px] mb-3" />
                <div className="h-3 bg-[#ede9e3] rounded-full w-1/3 mb-2" />
                <div className="h-5 bg-[#ede9e3] rounded-full w-3/4 mb-4" />
                <div className="h-6 bg-[#ede9e3] rounded-full w-1/4" />
              </div>
            ))}
          </div>
        ) : (
